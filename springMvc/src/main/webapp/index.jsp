...
<body class="" style="">
	<section class="vbox">
		<header class="bg-dark dk header navbar navbar-fixed-top-xs">
			<div class="navbar-header aside-md">
				<a class="btn btn-link visible-xs"
					...
					data-toggle="fullscreen">MES<font style="font-size: 12px;">制造执行系统</font></a>
		...
		<div class="div_center bg-dark nav">
			<p style="color: white">Copyright © 2016 - 2020  <a href="https://shop379896684.taobao.com/" target="_blank">奇趣资源优选</a></p>
		</div>
	</section>
	<!-- Bootstrap -->
